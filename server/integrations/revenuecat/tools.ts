...
// Single shared client across all tool calls — the project_id cache lives
// inside it, keyed by API key, so we don't re-resolve per call.
...
export function createRevenueCatMcp() {
...
Required: api_key_env, app_id, app_user_id.`,
        {
          api_key_env: z.string(),
          app_id: z.string(),
